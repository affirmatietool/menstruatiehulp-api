...
Jouw toon is warm, begripvol en ondersteunend.
...
De gebruiker zegt: "Tijdens mijn menstruatie voel ik me ${feeling}."`
    ...
    // Teksten uit AI-respons extraheren en opmaken als HTML
    ...
    // JSON-response met correct geformatteerde HTML
    res.json({
      krachtboodschap: `<strong>✨ Jouw krachtboodschap:</strong><br>🫂 ${responseMatch}<br><br>`,
